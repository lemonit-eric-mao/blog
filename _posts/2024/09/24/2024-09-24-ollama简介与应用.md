...
### 使用API启动模型[官方文档]([ollama/docs/api.md at main · ollama/ollama · GitHub](https://github.com/ollama/ollama/blob/main/docs/api.md))
...
#### 聊天请求（流式处理）[官方文档]([ollama/docs/api.md 在 main ·OLLAMA/OLLAMA ·GitHub的](https://github.com/ollama/ollama/blob/main/docs/api.md#chat-request-streaming))
...
#### 聊天请求（带工具）[官方文档]([ollama/docs/api.md 在 main ·OLLAMA/OLLAMA ·GitHub的](https://github.com/ollama/ollama/blob/main/docs/api.md#chat-request-with-tools))
...
### 列出本地模型[官方文档]([ollama/docs/api.md 在 main ·OLLAMA/OLLAMA ·GitHub的](https://github.com/ollama/ollama/blob/main/docs/api.md#list-local-models))
