...
**安装**
``` bash
root@weixin:~/nvm-0.40.3# bash install.sh
...
Receiving objects: 100% (383/383), 391.80 KiB | 1.02 MiB/s, done.
...
/usr/lib
├── corepack@0.32.0
├── ncm-ng@npm:@ns-private/ncm-ng@2.9.7
├── nsolid-cli@4.0.2
└── yarn@1.22.22
