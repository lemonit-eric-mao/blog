...
date: '2020-09-09T01:14:33+00:00'
status: publish
permalink: /2020/09/09/istio%e7%b3%bb%e5%88%97%e4%ba%8c-%e8%87%aa%e5%8a%a8%e5%8c%96%e9%83%a8%e7%bd%b2springboot%e5%ba%94%e7%94%a8%e7%a8%8b%e5%ba%8f%e5%88%b0k8s
author: 毛巳煜
excerpt: ''
type: post
id: 6132
...
WORKDIR /app
COPY ./target/<span class="katex math inline">{CI_PROJECT_NAME}.jar /app
EXPOSE 8066
...
CMD ["java", "-jar", "-Dspring.config.location=bootstrap.yml", "</span>{CI_PROJECT_NAME}.jar"]
...
my_tag:
  script:
    ...
    # 相当于: docker build -t harbor.software.com/library/<span class="katex math inline">{CI_PROJECT_NAME}:</span>{CI_COMMIT_TAG} -f ./Dockerfile .
    - envsubst  ${CI_PROJECT_NAME}/templates/service.yaml
    - envsubst  <span class="katex math inline">{CI_PROJECT_NAME}/templates/deployment.yaml
    - helm push</span>{CI_PROJECT_NAME} harbor-repo --version=${CI_COMMIT_TAG}
