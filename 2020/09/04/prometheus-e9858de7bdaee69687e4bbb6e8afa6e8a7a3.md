...
date: '2020-09-04T01:39:32+00:00'
status: publish
permalink: /2020/09/04/prometheus-%e9%85%8d%e7%bd%ae%e6%96%87%e4%bb%b6%e8%af%a6%e8%a7%a3
author: 毛巳煜
excerpt: ''
type: post
id: 6058
...
- job_name: prometheus  # 必须配置, 自动附加的job labels, 必须唯一
  ...
  - source_labels: [job, __meta_dns_name]   # 从现有的标签中选择源标签, 最后会被 替换， 保持， 丢弃
    ...
    replacement:   foo-<span class="katex math inline">{1}  # 如果正则表达匹配, 那么替换值. 可以使用正则表达中的 捕获组
...
```yaml
tee ./prometheus/config/prometheus.yml 
```
