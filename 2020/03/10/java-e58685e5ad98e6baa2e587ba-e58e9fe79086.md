---
title: 'Java 内存溢出-原理'
date: '2020-03-10T14:41:17+00:00'
status: publish
permalink: /2020/03/10/java-%e5%86%85%e5%ad%98%e6%ba%a2%e5%87%ba-%e5%8e%9f%e7%90%86
author: 毛巳煜
excerpt: ''
type: post
id: 5284
...
**`总结`**  
每执行一个方法都会向`栈`中`加入一个栈帧`，当`栈帧`的`数量`超过了栈的长度就会引发`StackOverflowError`异常
