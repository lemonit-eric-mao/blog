...
###### **[1900-2100区间内的公历、农历互转](https://blog.jjonline.cn/userInterFace/173.html "1900-2100区间内的公历、农历互转")**
...
```javascript
// // 接收输入阴历日期
// let solar = calendar.lunar2solar(1987, 1, 8);
// // 接收输入阳历日期
// let lunar = calendar.solar2lunar(1987, 2, 5);
// 默认今天阳历日期
let lunar = calendar.solar2lunar();
let demo = `<strong>万年历</strong>
<br/>
阳历： ${lunar.cYear} 年 ${lunar.cMonth} 月 ${lunar.cDay} 日（${lunar.astro}）
<br/>
农历： ${lunar.lYear} 年 ${lunar.IMonthCn + lunar.IDayCn}， ${lunar.gzYear}年 【${lunar.Animal}年】 ${lunar.gzMonth}月 ${lunar.gzDay}日`;
...
```javascript
// // 接收输入阴历日期
// let solar = new Calendar().lunar2solar(1987, 1, 8);
// // 接收输入阳历日期
// let lunar = new Calendar().solar2lunar(1987, 2, 5);
// 默认今天阳历日期
let lunar = new Calendar().solar2lunar();
let lunar = new Calendar().solar2lunar();
let demo = `<strong>万年历</strong>
<br/>
阳历： ${lunar.cYear} 年 ${lunar.cMonth} 月 ${lunar.cDay} 日（${lunar.astro}）
