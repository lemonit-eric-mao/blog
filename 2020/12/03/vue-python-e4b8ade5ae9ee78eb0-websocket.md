...
date: '2020-12-03T02:39:20+00:00'
status: publish
permalink: /2020/12/03/vue-python-%e4%b8%ad%e5%ae%9e%e7%8e%b0-websocket
author: 毛巳煜
excerpt: ''
type: post
id: 6610
...
class WS {
    ...
    onmessage(msg) {
        console.log(msg)
        this.send(`你好我是 Client <span class="katex math inline">{new Date()}`);
    }
...
// 添加到 Vue原型链
Vue.prototype.</span>WebSocket = new WS();
