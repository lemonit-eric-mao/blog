---
title: 公历、农历互转
date: '2020-12-27T11:01:05+00:00'
status: private
permalink: /2020/12/27/6707
author: 毛巳煜
excerpt: ''
type: post
id: 6707
...
export var calendar = {
    ...
    lunar2solar:function(y,m,d,isLeapMonth) {   //参数区间1900.1.31~2100.12.1
        ...
        if(y==2100&&m==12&&d>1 || y==1900&&m==1&&d 2100 || d > _day) {return -1;}//参数合法性效验

        //计算农历的时间差
        var offset = 0;
        for(var i=1900;i<y false="" for="" i="1;i<m;i++)" if="" leap="0,isAdd=" offset="" var="">0) {
...
<br></br>
阳历： <span class="katex math inline">{lunar.cYear} 年</span>{lunar.cMonth} 月 <span class="katex math inline">{lunar.cDay} 日（</span>{lunar.astro}）
<br></br>
农历： <span class="katex math inline">{lunar.lYear} 年</span>{lunar.IMonthCn + lunar.IDayCn}， <span class="katex math inline">{lunar.gzYear}年 【</span>{lunar.Animal}年】 <span class="katex math inline">{lunar.gzMonth}月</span>{lunar.gzDay}日`;
...
class Calendar {
    ...
    lunar2solar(y, m, d, isLeapMonth) {   //参数区间1900.1.31~2100.12.1
        ...
        if (y == 2100 && m == 12 && d > 1 || y == 1900 && m == 1 && d  2100 || d > _day) {
            return -1;
        }//参数合法性效验
