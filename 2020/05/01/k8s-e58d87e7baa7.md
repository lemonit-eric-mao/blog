---
title: 'K8S 升级'
date: '2020-05-01T04:51:42+00:00'
status: publish
permalink: /2020/05/01/k8s-%e5%8d%87%e7%ba%a7
author: 毛巳煜
excerpt: ''
type: post
id: 5327
...
**v`1.13.0` --&gt; v`1.14.2`** **正确**  
**v`1.13.0` --&gt; v`1.17.0`** **`错误`**
...
```ruby
<br></br>[root@test1 ~]# kubeadm upgrade apply 1.14.2 -y
