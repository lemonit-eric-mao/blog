...
```ruby
mao-siyu@pc:/mnt/1TB/download$ wget http://kdl.cc.ksosoft.com/wps-community/download/a21/wps-office_10.1.0.5672~a21_amd64.deb
...
```ruby
mao-siyu@pc:/mnt/1TB/download$ sudo dpkg -i wps-office_10.1.0.5672~a21_amd64.deb 
...
```ruby
# 下载缺少的库
mao-siyu@pc:/mnt/1TB/download$ wget http://kr.archive.ubuntu.com/ubuntu/pool/main/libp/libpng/libpng12-0_1.2.54-1ubuntu1_amd64.deb
...
mao-siyu@pc:/mnt/1TB/download$ ll
总用量 241596
...
```ruby
# 安装缺少的库
mao-siyu@pc:/mnt/1TB/download$ sudo dpkg -i libpng12-0_1.2.54-1ubuntu1_amd64.deb
