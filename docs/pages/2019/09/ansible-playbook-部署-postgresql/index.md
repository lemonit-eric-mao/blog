...
| test2 | 172.160.180.47 | 工作节点 GTM |
| test3 | 172.160.180.48 | 工作节点 (GTM\_Proxy, Coordinator, DataNode) |
| test4 | 172.160.181.18 | 工作节点 (GTM\_Proxy, Coordinator, DataNode) |
...
[gtm]
gtm ansible_ssh_host=172.160.181.18
...
[datanode]
datanode1 ansible_ssh_host=172.160.180.47
datanode2 ansible_ssh_host=172.160.180.48

[coordinator]
coordinator1 ansible_ssh_host=172.160.180.47
coordinator2 ansible_ssh_host=172.160.180.48
...
- hosts: servers
  tasks:
    - name: 配置 hosts 映射
      ...
      # 定义集合，并循环执行所在的模块
      with_items:
        - { key: "172.160.181.18", value: "gtm" }
        - { key: "172.160.180.47", value: "node1" }
        - { key: "172.160.180.48", value: "node2" }
eric
...
官网：https://www.postgres-xl.org/ 官网下载地址：https://www.postgres-xl.org/downloads/
