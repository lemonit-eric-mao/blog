---
title: "JavaScript加CSS3动画， 动态生成树菜单"
date: "2021-01-26"
categories: 
  - "javascript"
---
...
<div class="cn-foundation" id="foundation">
    ...
    <div class="cn-wrapper">
        ...
        <div class="left-wrapper">
            <div class="cn-tree" id="cnTree"></div>
        </div>
        <!--中间隔断-->
        <div class="line"></div>
        <!--右侧管理器-->
...
<script>
    ...
    let cnTree = document.getElementById('cnTree');
     ...
     * 构建树
     * @param treeData
     * @param childNode 子级对象
     */
    function buildTree(treeData, childNode) {
        ...
        treeData.map((item, index, sourceData) => {
            ...
            if (item.child.length) {
                buildTree(item.child, cnChild);
            }

            // 向子级对象或者父级对象，插入元素
            let tree = childNode || cnTree;
...
<!-- <!–左侧树–>-->
<!-- <div class="left-wrapper">-->
<!-- <div class="cn-tree" id="cnTree">-->

<!-- <div class="cn-item">-->
<!-- <div class="cn-node">-->
<!-- <i class="cn-icon dir-open"></i>-->
<!-- <label class="cn-name">一级</label>-->
<!-- </div>-->
<!-- <div class="cn-child">-->
<!-- <div class="cn-item">-->
<!-- <div class="cn-node">-->
<!-- <i class="cn-icon file"></i>-->
<!-- <label class="cn-name">二级.docker</label>-->
<!-- </div>-->
<!-- <div class="cn-child"></div>-->
<!-- </div>-->
<!-- </div>-->
...
<!-- <div class="cn-node">-->
<!-- <i class="cn-icon file"></i>-->
<!-- <label class="cn-name">a级.txt</label>-->
<!-- </div>-->
<!-- <div class="cn-child"></div>-->
<!-- </div>-->
<!-- </div>-->
