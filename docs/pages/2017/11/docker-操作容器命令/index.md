...
**docker save -o 打包的文件名.tar 镜像名称:版本号** **将多个image 导出到一个压缩文件中： `docker save calico/cni:v3.15.1 mariadb:10.5.4 | gzip > eric.docker`**
...
# 或者
[root@localhost maosiyu]# docker load < das-0.4.tar
