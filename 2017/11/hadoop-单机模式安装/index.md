...
```ruby
mao-siyu@mao-siyu-PC:~/MyHadoop$ tar -xzvf hadoop-2.8.1.tar.gz
mao-siyu@mao-siyu-PC:~/MyHadoop$ cd hadoop-2.8.1/
...
```ruby
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ pwd
/home/mao-siyu/MyHadoop/hadoop-2.8.1
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ sudo vim /etc/profile

export HADOOP_HOME=/home/mao-siyu/MyHadoop/hadoop-2.8.1
export PATH=$HADOOP_HOME/bin:$PATH
:wq!

mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ source /etc/profile
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$
...
**原因是在%HADOOP\_HOME%/etc/hadoop/hadoop-env.sh 内缺少JAVA\_HOME的定义，只需要把 hadoop-env.sh中 export JAVA\_HOME=${JAVA\_HOME} 改为 export JAVA\_HOME=/home/java/jdk1.8.0\_111**

```ruby
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ vim etc/hadoop/hadoop-env.sh
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ ./sbin/start-all.sh
...
```ruby
mao-siyu@mao-siyu-PC:~/MyHadoop/hadoop-2.8.1$ ./bin/hadoop fs -ls /
Found 26 items
