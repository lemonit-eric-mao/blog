...
date: '2017-12-14T15:24:21+00:00'
status: publish
permalink: /2017/12/14/%e5%8d%87%e7%ba%a7-package-json-%e4%b8%ad%e7%9a%84%e7%89%88%e6%9c%ac%e5%8f%b7
author: 毛巳煜
excerpt: ''
type: post
id: 1750
...
```ruby
mao-siyu@mao-siyu-PC:~/文档/code/dist-server<span class="katex math inline">sudo npm i -g npm-check
npm notice created a lockfile as package-lock.json. You should commit this file.
+ npm-check@5.6.0
added 240 packages in 27.361s
mao-siyu@mao-siyu-PC:~/文档/code/dist-server</span>
...
```ruby
mao-siyu@mao-siyu-PC:~/文档/code/dist-server<span class="katex math inline">sudo npm-check
